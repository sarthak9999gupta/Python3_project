...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 21 22:19:58 2023
...
print("Most doctors agree that bicycle of",verb_1," is a/an ",adj_1," form of exercise.",verb_2,"  a bicycle enables you to develop your ",body_part," muscles as well as ",adverb," increase the rate of a ",body_part_2," beat. More ",noun," around the world ",verb_3," bicycles than drive ",animal,". No matter what kind of ",noun_2,"you ",verb_4,", always be sure to wear a/an ",adj_2," helmet.Make sure to have ",color," reflectors too! ")
